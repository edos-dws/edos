...
Behavioral guidelines to reduce common LLM coding mistakes. Merge with project-specific instructions as
needed. **Apply these to all important operations (backend, frontend, or both).**
